...
#### Methods for Best Subset Selection -------------------

library(car)
subsets(regfit.full,statistic = "bic")
subsets(regfit.full,statistic = "cp")
subsets(regfit.full,statistic = "adjr2")
subsets(regfit.full,statistic = "rsq")
subsets(regfit.full,statistic = "rss")
...
library(ggfortify)
autoplot(lasso.mod)
autoplot(lasso.mod,xvar="norm")
autoplot(lasso.mod,xvar="lambda")
autoplot(lasso.mod,xvar="dev")
